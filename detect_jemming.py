...
def main():
    parser = argparse.ArgumentParser(description="Обработка файла и параметров для скрипта detect_jemming.py")
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python detect_jemming.py input_file min_snr min_sats [--system SYSTEM] [--band BAND] [--archive] [--plot] [--start_delay]")
        print("Example: python3 detect_jemming.py test_tau1312.cyno 30 5")
        sys.exit(1)
